...
//        foundByType.forEach(System.out::println);
    ...
    private static void loadFromAnnotations() {
        ...
        product.setDescription("La mejor panela");
        productService.createProduct(product);

        Product product1 = new Product();
        product1.setName("Yuca");
        product1.setDescription("La mejor tuca");
        productService.createProduct(product1);

        Product product2 = new Product();
        product2.setName("Arroz");
        product2.setDescription("La mejor arroz");
        productService.createProduct(product2);

        Product product3 = new Product();
        product3.setName("Tomate");
        product3.setDescription("La mejor tomate");
