...
public class AddressJdbcRepository implements AddressRepository {
    ...
    public <S extends Address> S save(final S entity) {
        final String insertQ = "INSERT INTO address (id, name, description, city, countryISOCode, regionISOCode, " +
                "phoneNumber, street1, street2, street3, zip)" +
                " VALUES (:id, :name, :description, :city, :countryISOCode, :regionISOCode, :phoneNumber, " +
                ":street1, :street2, :street3, :zip)";
        SqlParameterSource namedParameters = new MapSqlParameterSource()
                .addValue("id", entity.getId())
                .addValue("name", entity.getName())
                .addValue("description", entity.getName())
                .addValue("city", entity.getName())
