...
public class AddressJdbcRepository implements AddressRepository {
    ...
    public <S extends Address> S save(S entity) {
        final String insertQ = "INSERT INTO store (id, name, description, city, countryISOCode," +
                "regionISOCode, phoneNumber, street1, street2, street3, zip)" +
                " VALUES (:id, :name, :description, :city, :countryISOCode," +
                ":regionISOCode, :phoneNumber, :street1, :street2, :street3, :zip)";
